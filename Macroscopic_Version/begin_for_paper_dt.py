...
rand_file  = '/home/pmueller/Masterarbeit/Paper_Data/input/ini_pairs_41_diff_inact_Y0_1.npy'#random_pairs_1000.npy'
...
save_name = 'ana_paper_dt_41_y1_02'#'Ana_test_N__th_1000'#'test'#'network_size'
####



varying_param = np.logspace(-6,-2,5)
approx_calc_length = 10
j = 1
for v in varying_param:
    
    delta_t = v
    chuncks = 1 + int((1e-4/delta_t)*(approx_calc_length*number_of_random_pairs)//(3600*10)) # Every chunck should run about 2 hours
